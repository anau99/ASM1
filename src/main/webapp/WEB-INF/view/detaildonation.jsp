    ...
    <div class="container-fluid">
      <div class="row align-items-center">
        ...
        <nav class="mx-auto site-navigation">
          ...
          <!--    <li class="d-lg-none" ><a href="/user/logout" >Đăng xuất</a></li> -->
        <!--     <li class="d-lg-none" ><a href="/user/login">Đăng nhập</a></li> -->
          </ul>
        </nav>

        <div class="right-cta-menu text-right d-flex aligin-items-center col-6">
          <div class="ml-auto">
          <!--  <a  class="btn btn-outline-white border-width-2 d-none d-lg-inline-block"></span>Post a Job</a> -->
          <!--      <a href="/user/logout" class="btn btn-primary border-width-2 d-none d-lg-inline-block">Log Out</a>-->
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form action="addUserDonationByAdmin" modelAttribute="userdonation" method="post">
