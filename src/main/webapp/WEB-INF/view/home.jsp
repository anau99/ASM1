                  ...
                  <c:forEach var="donation" items="${donations}">
                    <li style="margin-bottom: 20px" class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center ">
                        <div class="job-listing-about d-sm-flex custom-width w-100 justify-content-between mx-4">
                            ...
                            <form action="detailDonation" method="get">
                            ...
                            <div class="job-listing-location mb-3 mb-sm-0 custom-width w-25" style="padding: 10px;">
                                <span class="icon-room"></span> <span text="${donation.organizationName}"></span><br>
                                <strong>${category.phoneNumber}</strong><br>
                            </div>
                          <c:choose>
                            <c:when test="${donation.status == 1}">
                              <div class="job-listing-meta custom-width w-20">
                                <p type="button"  style="margin-top: 20px" class="btn btn-primary py-2" data-bs-toggle="modal"
                                                            data-bs-target="#idmodal-${donation.id}">Quyên góp</p>
                            ...
                            <c:otherwise>
                              <!-- Hiển thị nội dung khác hoặc ẩn hoàn toàn -->
                            </c:otherwise>
                          </c:choose>
                        </div>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="idmodal-${donation.id}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form action="saveUserDonation" modelAttribute="userdonation" method="post">
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <textarea rows="10" cols="3" class="form-control" name="test">
